...
permalink: "browsers/index.html"
---

These are direct download links for popular web browsers. This page might be helpful if your existing browser is [interfering with the official download pages](https://www.windowslatest.com/2025/01/23/microsoft-edges-bing-now-hides-google-chrome-download-link-on-windows-11/), or you're having some other technical problem.

These links are *not* mirrors, they are just direct links to the official browser downloads. If you want to use a [Just the Browser configuration](/), you can install that afterwards.
